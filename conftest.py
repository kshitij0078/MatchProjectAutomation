...
def login(launch_browser):
    ...
    time.sleep(10)
    driver.find_element(By.XPATH, '//input[@type="email"]').send_keys("testsosmart@soprasteria.com")
    driver.find_element(By.XPATH, '//input[@type="submit"]').click()
    time.sleep(10)
    driver.find_element(By.XPATH, '//input[@name="Password"]').send_keys('nbG^xvW#DYanrNDE')
